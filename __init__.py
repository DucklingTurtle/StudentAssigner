                        ...
                        for teacher in teacher_pool:
                            if student.focus1 == teacher.focus and teacher.student1 == "" and i == 0:
                                if len(student.focus1_teachers) < 2:
                                    ...
                                    print(teacher.name)
                                    print("-Works-")
                            elif student.focus2 == teacher.focus and teacher.student1 == "" and i == 1:
        ...
        # block 2
            ...
            if len(student_pool) > 0 and len(teacher_pool) > 0:
                ...
                for i in range(2):
                    for student in student_pool:
                        for teacher in teacher_pool:
                            if student.focus1 == teacher.focus and teacher.student2 == "" and i == 0:
                                if len(student.focus1_teachers) < 2:
                                    student.focus1_teachers.append(teacher.name)
                                    ...
                                    print(teacher.name)
                                    print("-Works- Block 2")
                            elif student.focus2 == teacher.focus and teacher.student2 == "" and i == 1:
                                if len(student.focus2_teachers) < 2:
                                    student.focus2_teachers.append(teacher.name)
                                    teacher.student2 = student.name
                                    print(student.name)
            ...
            if len(student_pool) > 0 and len(teacher_pool) > 0:
                ...
                for i in range(2):
                    for student in student_pool:
                        for teacher in teacher_pool:
                            if student.focus1 == teacher.focus and teacher.student3 == "" and i == 0:
                                if len(student.focus1_teachers) < 2:
                                    student.focus1_teachers.append(teacher.name)
                                    ...
                                    print(teacher.name)
                                    print("-Works-")
                            elif student.focus2 == teacher.focus and teacher.student3 == "" and i == 1:
                                if len(student.focus2_teachers) < 2:
                                    student.focus2_teachers.append(teacher.name)
                                    teacher.student3 = student.name
                                    if 1 not in student.hours:
